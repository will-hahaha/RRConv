...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", default=0.0006, type=float, help="Base learning rate at the start of the training.")
    parser.add_argument("--ckpt", default=10, type=int, help="Save model every ckpt epochs.")
    parser.add_argument("--train_set_path", default="/Data2/JayHuang/data/pancollection/train_wv3_9714.h5",
                        type=str, help="Path to the training set.")
    parser.add_argument("--validate_set_path", default="/Data2/JayHuang/data/pancollection/valid_wv3_9714.h5",
